...
1.  The first data set is about Nigeria level 2 administrative boundaries, which contains GIS data for polygon features. The data is obtained from <https://data.humdata.org/dataset/nigeria-admin-level-0-1-and-2-administrative-boundaries>
...
Note: The second data set contains information of other countries, including Nigeria. The data cleaning and filtering for only Nigeria country are done before importing the data set into RStudio.
