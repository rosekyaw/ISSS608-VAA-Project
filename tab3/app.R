...
server <- function(input, output) {
  ...
  attributeInput <- reactive({
    switch(
      ...
      "pct_functionalpct_ucN1000pct_nonFunctional" = clustFuncNfuncX1000Ward,
      "pct_urban0pct_functionalpct_nonFunctional" = clustFuncNfuncUrban0Ward,
      ...
      "pct_ps09pct_functionalpct_nonFunctional" = clustFuncNfuncPS09Ward,
      "pct_ps10pct_functionalpct_nonFunctional" = clustFuncNfuncPS19Ward,
      
      "pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clustFuncNfuncHMPumpWard,
      "pct_handPumppct_ucN1000pct_functionalpct_nonFunctional" = clustFuncNfuncHPump1kWard,
      "pct_handPumppct_urban0pct_functionalpct_nonFunctional" = clustFuncNfuncHPumpUrban0Ward,
      "pct_handPumppct_cs04pct_functionalpct_nonFunctional" = clustFuncNfuncHPumpCS04Ward,
      "pct_handPumppct_cs10pct_functionalpct_nonFunctional" = clustFuncNfuncHPumpCS10Ward,
      "pct_handPumppct_ps09pct_functionalpct_nonFunctional" = clustFuncNfuncHPumpPS09Ward,
      "pct_handPumppct_ps19pct_functionalpct_nonFunctional" = clustFuncNfuncHPumpPS19Ward,
      
      "pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clustFuncNfuncHMPump1kWard,
      "pct_urban0pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clustFuncNfuncHMPumpUrban0Ward,
      "pct_cs04pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clustFuncNfuncHMPumpCS04Ward, 
      "pct_cs10pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clustFuncNfuncHMPumpCS10Ward,
      "pct_ps09pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clustFuncNfuncHMPumpPS09Ward,
      "pct_ps19pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clustFuncNfuncHMPumpPS19Ward,
      
      "pct_urban0pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clustFuncNfuncHMPump1kUrban0Ward,       
      "pct_cs04pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clustFuncNfuncHMPump1kCS04Ward,
      "pct_cs10pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clustFuncNfuncHMPump1kCS10Ward,        
      "pct_ps09pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clustFuncNfuncHMPump1kPS09Ward,
      "pct_ps19pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clustFuncNfuncHMPump1kPS19Ward,
      "pct_cs04pct_urban0pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clustFuncNfuncHMPump1kUrban0CS04Ward,  
      "pct_cs10pct_urban0pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clustFuncNfuncHMPump1kUrban0CS10Ward,
      "pct_ps09pct_urban0pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clustFuncNfuncHMPump1kUrban0PS09Ward,
      "pct_ps19pct_urban0pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clustFuncNfuncHMPump1kUrban0PS19Ward,
      "pct_ps19pct_ps09pct_cs10pct_cs04pct_urban0pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clustAllVWard)
  })
  ...
  boundaryInput <- reactive({
    boundaryInput <- switch(
      ...
      "pct_functionalpct_ucN1000pct_nonFunctional" = funcNfuncX1000,
      "pct_cs04pct_functionalpct_nonFunctional" = funcNfuncUrban0,
      "pct_cs04pct_functionalpct_nonFunctional" = funcNfuncCS4,
      "pct_cs10pct_functionalpct_nonFunctional" = funcNfuncCS10,
      "pct_ps09pct_functionalpct_nonFunctional" = funcNfuncPS09,
      "pct_ps10pct_functionalpct_nonFunctional" = funcNfuncPS19,
      "pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = funcNfuncHMPump,
      "pct_handPumppct_ucN1000pct_functionalpct_nonFunctional" = funcNfuncHPump1k,
      "pct_handPumppct_urban0pct_functionalpct_nonFunctional" = funcNfuncHPumpUrban0,
      "pct_handPumppct_cs04pct_functionalpct_nonFunctional" = funcNfuncHPumpCS04,
      "pct_handPumppct_cs10pct_functionalpct_nonFunctional" = funcNfuncHPumpCS10,
      "pct_handPumppct_ps09pct_functionalpct_nonFunctional" = funcNfuncHPumpPS09,
      "pct_handPumppct_ps19pct_functionalpct_nonFunctional" = funcNfuncHPumpPS19,
      
      "pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = funcNfuncHMPump1k,
      "pct_urban0pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = funcNfuncHMPumpUrban0,
      "pct_cs04pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = funcNfuncHMPumpCS04, 
      "pct_cs10pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = funcNfuncHMPumpCS10,
      "pct_ps09pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = funcNfuncHMPumpPS09,
      "pct_ps19pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = funcNfuncHMPumpPS19,
      
      "pct_urban0pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = funcNfuncHMPump1kUrban0,       
      "pct_cs04pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = funcNfuncHMPump1kCS04,
      "pct_cs10pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = funcNfuncHMPump1kCS10,        
      "pct_ps09pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = funcNfuncHMPump1kPS09,
      "pct_ps19pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = funcNfuncHMPump1kPS19,
      "pct_cs04pct_urban0pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = funcNfuncHMPump1kUrban0CS04,  
      "pct_cs10pct_urban0pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = funcNfuncHMPump1kUrban0CS10,
      "pct_ps09pct_urban0pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = funcNfuncHMPump1kUrban0PS09,
      "pct_ps19pct_urban0pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = funcNfuncHMPump1kUrban0PS19,
      "pct_ps19pct_ps09pct_cs10pct_cs04pct_urban0pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = allV
    )
  ...
  optKInput <- reactive({
    optKInput <- switch(
      ...
      "pct_functionalpct_ucN1000pct_nonFunctional" = clust_funcNfuncX1000,
      "pct_cs04pct_functionalpct_nonFunctional" = clust_funcNfuncUrban0,
      "pct_cs04pct_functionalpct_nonFunctional" = clust_funcNfuncCS4,
      "pct_cs10pct_functionalpct_nonFunctional" = clust_funcNfuncCS10,
      "pct_ps09pct_functionalpct_nonFunctional" = clust_funcNfuncPS09,
      "pct_ps10pct_functionalpct_nonFunctional" = clust_funcNfuncPS19,
      "pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clust_funcNfuncHMPump,
      "pct_handPumppct_ucN1000pct_functionalpct_nonFunctional" = clust_funcNfuncHPump1k,
      "pct_handPumppct_urban0pct_functionalpct_nonFunctional" = clust_funcNfuncHPumpUrban0,
      "pct_handPumppct_cs04pct_functionalpct_nonFunctional" = clust_funcNfuncHPumpCS04,
      "pct_handPumppct_cs10pct_functionalpct_nonFunctional" = clust_funcNfuncHPumpCS10,
      "pct_handPumppct_ps09pct_functionalpct_nonFunctional" = clust_funcNfuncHPumpPS09,
      "pct_handPumppct_ps19pct_functionalpct_nonFunctional" = clust_funcNfuncHPumpPS19,
      
      "pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clust_funcNfuncHMPump1k,
      "pct_urban0pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clust_funcNfuncHMPumpUrban0,
      "pct_cs04pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clust_funcNfuncHMPumpCS04, 
      "pct_cs10pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clust_funcNfuncHMPumpCS10,
      "pct_ps09pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clust_funcNfuncHMPumpPS09,
      "pct_ps19pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clust_funcNfuncHMPumpPS19,
      
      "pct_urban0pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clust_funcNfuncHMPump1kUrban0,       
      "pct_cs04pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clust_funcNfuncHMPump1kCS04,
      "pct_cs10pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clust_funcNfuncHMPump1kCS10,        
      "pct_ps09pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clust_funcNfuncHMPump1kPS09,
      "pct_ps19pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clust_funcNfuncHMPump1kPS19,
      "pct_cs04pct_urban0pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clust_funcNfuncHMPump1kUrban0CS04,  
      "pct_cs10pct_urban0pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clust_funcNfuncHMPump1kUrban0CS10,
      "pct_ps09pct_urban0pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clust_funcNfuncHMPump1kUrban0PS09,
      "pct_ps19pct_urban0pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clust_funcNfuncHMPump1kUrban0PS19,
      "pct_ps19pct_ps09pct_cs10pct_cs04pct_urban0pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clust_allV
    )
  })
  ...
  heatmapInput <- reactive({
    heatmapInput <- switch(
      ...
      "pct_functionalpct_ucN1000pct_nonFunctional" = clust_funcNfuncX1000Mat,
      "pct_cs04pct_functionalpct_nonFunctional" = clust_funcNfuncUrban0Mat,
      ...
      "pct_ps09pct_functionalpct_nonFunctional" = clust_funcNfuncPS09Mat,
      "pct_ps10pct_functionalpct_nonFunctional" = clust_funcNfuncPS19Mat,
      "pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clust_funcNfuncHMPumpMat,
      "pct_handPumppct_ucN1000pct_functionalpct_nonFunctional" = clust_funcNfuncHPump1kMat,
      "pct_handPumppct_urban0pct_functionalpct_nonFunctional" = clust_funcNfuncHPumpUrban0Mat,
      "pct_handPumppct_cs04pct_functionalpct_nonFunctional" = clust_funcNfuncHPumpCS04Mat,
      "pct_handPumppct_cs10pct_functionalpct_nonFunctional" = clust_funcNfuncHPumpCS10Mat,
      "pct_handPumppct_ps09pct_functionalpct_nonFunctional" = clust_funcNfuncHPumpPS09Mat,
      "pct_handPumppct_ps19pct_functionalpct_nonFunctional" = clust_funcNfuncHPumpPS19Mat,
      
      "pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clust_funcNfuncHMPump1kMat,
      "pct_urban0pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clust_funcNfuncHMPumpUrban0Mat,
      "pct_cs04pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clust_funcNfuncHMPumpCS04Mat, 
      "pct_cs10pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clust_funcNfuncHMPumpCS10Mat,
      "pct_ps09pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clust_funcNfuncHMPumpPS09Mat,
      "pct_ps19pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clust_funcNfuncHMPumpPS19Mat,
      
      "pct_urban0pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clust_funcNfuncHMPump1kUrban0Mat,       
      "pct_cs04pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clust_funcNfuncHMPump1kCS04Mat,
      "pct_cs10pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clust_funcNfuncHMPump1kCS10Mat,        
      "pct_ps09pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clust_funcNfuncHMPump1kPS09Mat,
      "pct_ps19pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clust_funcNfuncHMPump1kPS19Mat,
      "pct_cs04pct_urban0pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clust_funcNfuncHMPump1kUrban0CS04Mat,  
      "pct_cs10pct_urban0pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clust_funcNfuncHMPump1kUrban0CS10Mat,
      "pct_ps09pct_urban0pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clust_funcNfuncHMPump1kUrban0PS09Mat,
      "pct_ps19pct_urban0pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clust_funcNfuncHMPump1kUrban0PS19Mat,
      "pct_ps19pct_ps09pct_cs10pct_cs04pct_urban0pct_ucN1000pct_handPumppct_mechPumppct_functionalpct_nonFunctional" = clust_allVMat
    )
  })
